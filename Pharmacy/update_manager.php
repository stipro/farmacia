...
<html>
<head>
<title><?php $username?>Sistema de farmacia tusolutionweb</title>
...
<hr/>
    <div class="tabbed_area">
        ...
        <ul class="tabs">
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">Actualizar usuario</a></li>
