...
<html>
<head>
<title><?php echo $username;?> - Sistema de farmacia tusolutionweb</title>
...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/hd_logo.jpg"></a> Sistema de farmacia tusolutionweb</h1></div>
<div id="left_column">
<div id="button">
<ul>
...
<div id="tabbed_box" class="tabbed_box">
    <h4>Administrar cajero</h4>
<hr/>
    <div class="tabbed_area">


        <ul class="tabs">
 <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">Ver usuario</a></li>
            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">Agregar usuario</a></li>
