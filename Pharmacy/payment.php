...
<div id="button">
		<ul>
			...
			<li><a href="payment.php"target="_top">Proceso de pago</a></li>
...
<hr/>
    <div class="tabbed_area">
        ...
        <ul class="tabs">
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1">Pagos de proceso</a></li>
		...
		<div id="viewer1"><span id="viewer2"></span></div>
		  <form name="myform" onsubmit="return validateForm(this);" action="receipt.php" method="post" >
			<table width="220" height="106" border="0" >
				...
				$getpayType = $mbd->prepare("SELECT Name FROM paymentTypes");
				$getpayType->execute();
...
<div id="footer" align="Center">  Sistema de farmacia <a href="http://www.stipro.com/">@stipro</a>. derechos reservados</div>
</div>
</body>
</html>
