            ...
            <div id="main">
                <div id="tabbed_box" class="tabbed_box">
                    ...
                    <div class="tabbed_area">
                        <ul class="tabs">
                            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">Farmacéutico</a></li>
                            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">Cajero</a></li>
                            <li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">Administrador</a></li>
                        </ul>
                        <div id="content_1" class="content">
                            <?php 
                                ...
                                */
                                ...
                                $result = $mbd->prepare("SELECT * FROM pharmacist");
                                $result->execute();
                            ...
                            ?>
                                    ...
                                    */
                                    ...
                                    // get results from database
                                    $result = $mbd->prepare("SELECT * FROM cashier");
                                    $result->execute();
                                    // display data in table
                            ...
                            ?>
                                    ...
                                    */
                                    ...
                                    // get results from database
                                    $result = $mbd->prepare("SELECT * FROM manager");
                                    $result->execute();
                                    // display data in table
