...
<div id="main">
<h4 style="color:sienna; margin-left: 200px; font-size:20px;">Ha agregado correctamente y entidad a la base de datos</h4>
<!-- Dashboard icons -->
            <div class="grid_7">
